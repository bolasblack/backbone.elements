...
(function() {
  ...
  (function(jQuery, _, Backbone) {
    var $, delegateEvents, reEscape, _configure, _ref;
    ...
    _ref = Backbone.View.prototype, $ = _ref.$, _configure = _ref._configure, delegateEvents = _ref.delegateEvents;
    return _.extend(Backbone.View.prototype, {
      elementsPrefix: "$",
      _elementsSymbolSpliter: ["\\#", "\\.", "\\,", "\\s", "\\>", "\\+", "\\~", "\\[", "\\:"],
      $: function(selector) {
        return $.call(this, this._parseSymbolSelector(selector));
      },
      ...
      _parseSymbolSelector: function(selector) {
