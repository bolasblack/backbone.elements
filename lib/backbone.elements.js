...
(function() {
  ...
  (function(jQuery, _, Backbone) {
    var console, delegateEvents, nop, original$, reEscape, _configure, _ref;
    nop = function() {};
    ...
    return _.extend(Backbone.View.prototype, {
      ...
      _configure: function(options) {
        ...
        return this.dispose = function() {
          ...
          dispose.apply(_this, arguments);
          _this.clearElements();
          return _this._disposed = true;
        };
      },
      ...
      parseSelectorSymbol: function(selector) {
        var cannotParseSymbols, elementSymbol, elementsSelectorRE, endReStr, parsedSelector,
          _this = this;
        endReStr = this._elementsSymbolSpliter.join("|") + "|" + this._specialSymbolBreaker.join("|");
      ...
      _negativeReStr: function() {
        return (this._elementsSymbolSpliter.join("")) + this._regPrefix + this._specialSymbolBreaker;
      }
    });
  })(jQuery, _, Backbone);
